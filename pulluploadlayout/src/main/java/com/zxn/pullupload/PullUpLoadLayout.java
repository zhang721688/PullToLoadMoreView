...
public class PullUpLoadLayout extends ViewGroup {
    ...
    PullUpScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (PullUpScrollView) getChildAt(0);
                bottomScrollView = (PullUpScrollView) getChildAt(1);
                topScrollView.setScrollListener(new PullUpScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new PullUpScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
